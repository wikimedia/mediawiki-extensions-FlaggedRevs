...
[[{{MediaWiki:Validationpage}}|التحقق من]] جودتها.",
	'revreview-note'               => '[[User:$1]] كتب الملاحظات التالية [[{{MediaWiki:Validationpage}}|عند مراجعة]] هذه المراجعة:',
...
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} مقارنة])",
	...
	'revreview-successful'         => "'''المراجعة المختارة من [[:$1|$1]] تم التعليم عليها بنجاح. ([{{fullurl:Special:Stableversions|page=$2}} عرض كل النسخ المعلمة])'''",
	'revreview-successful2'        => "'''المراجعة المختارة من [[:$1|$1]] تمت إزالة علمها بنجاح.'''",
