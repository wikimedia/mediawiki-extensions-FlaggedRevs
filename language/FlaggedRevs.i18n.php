...
Please check the URL you used to access this page.',
	...
	'readerfeedback-level-none'    => '(select)',
...
Siehe auch die [[Special:StablePages|Liste markierter Versionen]].',
	...
	'readerfeedback-level-none' => '(auswählen)',
...
Listo de stabiligitaj paĝoj estas trovebla ĉe la [[Special:StablePages|Listo de stabilaj paĝoj]].',
	...
	'readerfeedback-level-none' => '(selekti)',
...
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} comparer])",
	...
	'revreview-submit' => 'Sauvegarder la relecture',
...
Consulter aussi la [[Special:StablePages|liste de pages stables]].',
	...
	'readerfeedback-level-none' => '(sélection)',
...
$messages['hu'] = array(
	...
	'flaggedrevs-backlog' => "'''Figyelem!''' Az [[Special:OldReviewedPages|elavult jelölésű lapok listájában]] várakozó lapok vannak.",
	...
	'flaggedrevs-prefs-stable' => 'A megjelölt lapváltozat mutatása alapértelmezettként, ha létezik ilyen.',
	...
	'hist-quality-user' => '[[User:$3|$3]] által [{{fullurl:$1|stableid=$2}} megjelölve]',
	'hist-stable' => 'megtekintett változat',
	'hist-stable-user' => '[[User:$3|$3]] által [{{fullurl:$1|stableid=$2}} megtekintve]',
	'review-diff2stable' => 'Az elfogadott és a legutóbbi változat közötti eltérések megtekintése',
...
naplója.',
	...
	'revreview-auto-w' => "Jelenleg a lap elfogadott változatát szerkeszted. Bármilyen változtatás '''automatikusan ellenőrzött lesz'''.",
	'revreview-auto-w-old' => "Jelenleg a lap egy ellenőrzött változatát szerkeszted. Bármilyen változtatás '''automatikusan ellenőrzött lesz'''.",
	'revreview-basic' => 'Ez a legutolsó [[{{MediaWiki:Validationpage}}|megtekintett]] változat,
[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} elfogadva]: <i>$2</i> Az [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} ellenőrizetlen változat] [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3 változtatása] vár megtekintésre.',
	'revreview-basic-i' => 'Ez a legutolsó [[{{MediaWiki:Validationpage}}|megtekintett]] változat, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} elfogadva]: <i>$2</i> A [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} változathoz] [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} sablon- vagy képváltoztatások] várnak ellenőrzésre.',
	'revreview-basic-old' => 'Ez egy [[{{MediaWiki:Validationpage}}|megtekintett]] változat ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} teljes lista]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} ellenőrizve]: <i>$2</i>.
...
egy dinamikus sablon más képet vagy sablont illeszt be egy változótól függően, ami megváltozott a lap ellenőrzésének kezdete óta. Az oldal frissítése és az ellenőrzés újbóli elvégzése megoldhatja a problémát.",
	...
	'revreview-edited' => "'''A szerkesztés akkor fog megjelenni a [[{{MediaWiki:Validationpage}}|megtekintett változatban]], amint egy ellenőr megtekintette.'''
'''Az ''ellenőrizetlen változat'' lent látható.''' [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $2 változtatás vár] megtekintésre.",
	'revreview-flag' => 'Legutóbbi változat ellenőrzése',
...
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Sablonok vagy képek változtatásait] kell ellenőrizni.',
	'revreview-newest-quality' => 'A [{{fullurl:{{FULLPAGENAMEE}}|stable=1}} legutóbbi ellenőrzött változat]
([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} összes]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} megjelölve]: <i>$2</i> [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3 változást] kell ellenőrizni.',
	'revreview-newest-quality-i' => 'A [{{fullurl:{{FULLPAGENAMEE}}|stable=1}} legutóbbi ellenőrzött változat] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} összes]); [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} megjelölve]: <i>$2</i>.
...
[[{{MediaWiki:Validationpage}}|ellenőrizni]] minőség alapján.",
	...
	'revreview-patrol-title' => 'Ellenőrzöttnek jelölöm',
	'revreview-patrolled' => '[[:$1|$1]] kiválasztott változata ellenőrzöttnek lett jelölve.',
	'revreview-quality' => 'Ez a legutolsó [[{{MediaWiki:Validationpage}}|ellenőrzött]] változat,
[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} elfogadva] ekkor: <i>$2</i> A [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} vázlaton] [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3
változtatást] kell ellenőrizni.',
	'revreview-quality-i' => 'Ez a legutolsó [[{{MediaWiki:Validationpage}}|ellenőrzött]] változat,
...
változtatást] kell ellenőrizni.',
	'revreview-quality-old' => 'Ez az utolsó [[{{MediaWiki:Validationpage}}|ellenőrzött]]  változat ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} összes]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approved] on <i>$2</i>
Új [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} változtatások] történhettek.',
	'revreview-quality-same' => 'Ez az utolsó [[{{MediaWiki:Validationpage}}|ellenőrzött]] lapváltozat ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} összes]); [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} megjelölés] dátuma: <i>$2</i>',
	'revreview-quality-title' => 'Ellenőrzött szócikk',
	'revreview-quick-basic' => "'''[[{{MediaWiki:Validationpage}}|Megtekintett]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} utolsó változat megtekintése]]",
	...
	'revreview-quick-basic-same' => "'''[[{{MediaWiki:Validationpage}}|Megtekintett]]'''",
	'revreview-quick-invalid' => "'''A változat azonosítója érvénytelen'''",
	'revreview-quick-none' => "'''[[{{MediaWiki:Validationpage}}|Legutóbbi]]''' (ellenőrizetlen) változat",
	...
	'revreview-quick-quality-same' => "'''[[{{MediaWiki:Validationpage}}|Minőségi]]'''",
...
($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} változás])",
	...
	'revreview-stable-title' => 'Megtekintett szócikk',
...
[{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} be lehet állítani].',
	...
	'stable-logpage' => 'Megjelölt változatok naplója',
...
Verifica le adresse URL que tu ha usate pro acceder a iste pagina.',
	...
	'readerfeedback-level-none' => '(selige)',
...
[[Special:Unreviewedpages|査読待ちのページ一覧]]をご覧ください。',
	...
	'revreview-quick-see-basic' => "'''草稿''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} 記事を見る]] ([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} 比較する])",
	'revreview-quick-see-quality' => "'''草稿''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} 記事を見る]] ([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} 比較する])",
...
$messages['lb'] = array(
	...
	'readerfeedback-level-none' => '(auswielen)',
...
Odświeżenie strony i ponowne sprawdzenie może rozwiązać ten problem.",
	...
	'revreview-editnotice' => "'''Uwaga: Edycje dokonane na tej stronie zostaną włączone do [[{{MediaWiki:Validationpage}}|wersji stabilnej]] po przejrzeniu ich przez uprawnionego użytkownika.'''",
	'revreview-flag' => 'Oznacz tę wersję',
	'revreview-edited' => "'''Edycje zostaną dołączone do [[{{MediaWiki:Validationpage}}|wersji stabilnej]], gdy tylko odpowiedni użytkownik je sprawdzi.'''
...
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Zmiany szablonów/grafik] wymagają przejrzenia.',
	'revreview-newest-quality' => '[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} Ostatnia wersja stabilna] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} pokaż wszystkie]) została [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>.
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3 {{PLURAL:$3|zmiana|zmiany|zmian}}] {{PLURAL:$3|oczekuje|oczekują|oczekuje}} na sprawdzenie.',
	'revreview-newest-quality-i' => '[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} Ostatnia wersja stabilna] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} pokaż wszystkie]) została [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>.
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Zmiany szablonów/grafik] wymagają sprawdzenia.',
	...
	'revreview-quality' => 'To jest najnowsza [[{{MediaWiki:Validationpage}}|wersja stabilna]], [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>.
[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} Szkic] posiada [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3 {{PLURAL:$3|zmianę|zmiany|zmian}}] {{PLURAL:$3|oczekującą|oczekujące|oczekujących}} na sprawdzenie.',
	'revreview-quality-i' => 'To jest najnowsza [[{{MediaWiki:Validationpage}}|wersja stabilna]], [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>.
[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} Szkic] posiada [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} zmiany szablonów/grafik] oczekujące na sprawdzenie.',
	'revreview-quality-old' => 'To jest [[{{MediaWiki:Validationpage}}|wersja stabilna]] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} pokaż wszystkie]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>.
Mogły zostać dokonane nowe [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} zmiany].',
	'revreview-quality-same' => 'To jest najnowsza [[{{MediaWiki:Validationpage}}|wersja stabilna]] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} pokaż wszystkie]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>.',
	'revreview-quality-source' => '[{{fullurl:{{FULLPAGENAMEE}}|stableid=$1}} Wersja stabilna] tej strony, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzona] <i>$2</i>, została oparta na tej wersji.',
	'revreview-quality-title' => 'Artykuł stabilny',
	...
	'revreview-quick-see-basic' => "'''Szkic''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} zobacz wersję przejrzaną]]
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} porównaj])",
	'revreview-quick-see-quality' => "'''Szkic''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} zobacz wersję przejrzaną]]
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} porównaj])",
	...
	'revreview-text' => "''[[{{MediaWiki:Validationpage}}|Wersje przejrzane]] są wyświetlana domyślnie dla czytelników, nawet jeśli istnieją nowsze, nieprzejrzane wersje.''",
	...
	'revreview-toolow' => 'Musisz ocenić każdy z atrybutów wyżej niż „nieakceptowalny“, aby uważać wersję za zrecenzowaną. 
By wycofać recenzję należy ustawić wszystkie pola na „nieakceptowalny“.',
	'revreview-update' => "Proszę [[{{MediaWiki:Validationpage}}|przejrzeć]] zmiany ''(patrz niżej)'' dokonane od momentu [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzenia] ostatniej wersji jako stabilnej.<br />
'''Niektóre szablony/grafiki zostały uaktualnione:'''",
	'revreview-update-includes' => "'''Niektóre szablony/grafiki zostały uaktualnione:'''",
	'revreview-update-none' => "Proszę [[{{MediaWiki:Validationpage}}|przejrzeć]] zmiany ''(patrz niżej)'' dokonane od momentu [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} zatwierdzenia] ostatniej wersji jako stabilnej.",
	'revreview-update-use' => "'''UWAGA:''' Jeśli którykolwiek z tych szablonów lub grafik posiadają wersję stabilną, to zostanie ona użyta w wersji stabilnej tej strony.",
	'revreview-diffonly' => "''By zrecenzować stronę, proszę kliknąć na link \"bieżąca wersja\" i użyć formularza recenzji.''",
...
[{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} skonfigurowane] ustawienia.'''",
	...
	'specialpages-group-quality' => 'Zapewnianie jakości',
...
Zobacz również [[Special:StablePages|listę skonfigurowanych stron]].',
	...
	'readerfeedback-success' => "'''Dziękujemy za ocenę tej stronie!''' ([$3 Komentarze lub pytania?]).",
	...
	'revreview-filter-level-1' => 'Stabilne wersje',
	'revreview-statusfilter' => 'Status:',
...
Môžete si pozrieť [[Special:StablePages|Zoznam stabilných stránok]].',
	...
	'readerfeedback-level-none' => '(výber)',
...
Danh sách các trang ổn định có thể tìm thấy tại [[Special:StablePages|danh sách trang ổn định]].',
	...
	'readerfeedback-level-none' => '(chọn)',
