...
[[Special:Unreviewedpages|未査読ページ一覧]]を参照してください。',
	...
	'revreview-visibility2' => "'''このページには古くなった[[{{MediaWiki:Validationpage}}|安定版]]があります。[{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} ページの安定度設定]は変更可能です。'''",
	'revreview-visibility3' => "'''このページには[[{{MediaWiki:Validationpage}}|安定版]]がありません。[{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} ページの安定度設定]は変更可能です。'''",
