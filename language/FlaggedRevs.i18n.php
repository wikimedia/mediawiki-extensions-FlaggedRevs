...
Új [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} változtatások] történhettek.',
	...
	'revreview-quick-basic-old' => "'''[[{{MediaWiki:Validationpage}}|Megtekintett szócikk]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} nem ellenőrzött változat megtekintése]]",
	'revreview-quick-basic-same' => "'''[[{{MediaWiki:Validationpage}}|Megtekintett szócikk]]'''",
