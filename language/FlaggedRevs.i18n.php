...
قائمة بالصفحات المستقرة يمكن العثور عليها في [[Special:StablePages|قائمة الصفحات المستقرة]].',
	...
	'revreview-linksmixed' => "''الصفحات معروضة هنا بناء على النسخ المسودة والمستقرة (لو كانت موجودة) للصفحات.''",
...
Listo de stabiligitaj paĝoj estas trovebla ĉe la [[Special:StablePages|Listo de stabilaj paĝoj]].',
	...
	'revreview-linksmixed' => "''Paĝoj estas listigitaj ĉi tie en ambaŭ la malneta kaj stabila versio (se ekzistante) de paĝoj.''",
...
Consulter aussi la [[Special:StablePages|liste de pages stables]].',
	...
	'revreview-linksmixed' => "''Les pages sont listées ici sous leurs versions brouillon ou stable (s’il y en a).''",
...
'''Alcuni template o immagini sono stati aggiornati:'''",
	...
	'revreview-typefilter' => 'Tipo:',
	'revreview-tagfilter' => 'Tag:',
	'revreview-linksmixed' => "''Le pagine elencate qui sono basate sia sulle bozze sia sulle versioni stabili (se presenti) delle pagine.''",
...
Resultaten van waarderingen van lezers voor '''$1''' zijn [$2 hier] te vinden.",
	...
	'revreview-typefilter' => 'Type:',
	'revreview-tagfilter' => 'Tag:',
	'revreview-linksmixed' => "''Pagina's worden hier weergegevens gebaseerd op zowel de werkversie als de stabiele versie (als aanwezig) van pagina's.''",
...
'''Qualques imatges o modèls son estats meses a jorn :'''",
	...
	'revreview-linksmixed' => "''Las paginas son listadas aicí jos lors versions borrolhon o establa (se n'i a).''",
...
Môžete si pozrieť [[Special:StablePages|Zoznam stabilných stránok]].',
	...
	'revreview-linksmixed' => "''Tu uvedené stránky sú založené na návrhoch aj na stabilných verziách (ak existujú) stránok.''",
...
En lista över stabiliserade sidor kan hittas på [[Special:StablePages|listan över stabila sidor]].',
	...
	'revreview-linksmixed' => "''Sidor som listas här baserade både på utkastet och den stabila versionen (som det finns någon) av sidan.''",
