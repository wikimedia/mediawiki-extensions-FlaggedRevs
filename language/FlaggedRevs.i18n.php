...
Por favor, revise la dirección que usó para acceder a esta página.',
	...
	'revreview-filter-manual' => 'Manual',
	'revreview-filter-level-0' => 'Versiones vistas',
	'revreview-filter-level-1' => 'Versiones de calidad',
...
$messages['gsw'] = array(
	...
	'flaggedrevs-backlog' => 'D [[Special:OldReviewedPages|Lischt vu dr Syte mit nit gsichtete Versione]] isch seli lang. Bitte hilf mit, si abzschaffe. Dankschen!',
	'flaggedrevs-desc' => 'Git Sichter un Priefer d Megligkeit Versione z priefe un Syte z sichte',
	...
	'review-diff2stable' => 'Unterschid zwische dr gsichtete un dr aktuälle Version aaluege',
	'review-logentry-app' => 'het „[[$1]]“ prieft',
	'review-logentry-dis' => 'het e Markierig vu „[[$1]]“ usegnuh',
	'review-logentry-id' => 'Versions-ID $1',
	'review-logentry-diff' => 'Unterschid zue dr gsichtete Version',
	...
	'revreview-auto' => '(automatisch)',
	'revreview-auto-w' => "Du bearbeitesch e gsichteti Version; Bearbeitige wäre '''automatisch as gsichtet''' markiert.",
	'revreview-auto-w-old' => "Du bearbeitesch e gsichteti Version; Bearbeitige wäre '''automatisch as gsichtet''' markiert.",
	...
	'revreview-basic-i' => 'Des isch di letscht [[{{MediaWiki:Validationpage}}|gsichtet]] Version, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} frejgee] am <i>$2</i>.
Im [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} Entwurf] het s [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Änderige an Vorlage/Dateie], wu no gsichtet mieße wäre.',
	'revreview-basic-old' => 'Des isch e [[{{MediaWiki:Validationpage}}|gsichteti]] Version ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} → alli]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} frejgee] am <i>$2</i>.
S cha syy, ass es neiji [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Änderige] dra gee het.',
	'revreview-basic-same' => "Des isch di letscht [[{{MediaWiki:Validationpage}}|gsichtet]] Version, ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} zeig alli]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} frejgee] am <i>$2</i>. D Syte cha '''[{{fullurl:{{FULLPAGENAMEE}}|action=edit}} bearbeitet]''' wäre.",
	'revreview-basic-source' => 'E [{{fullurl:{{FULLPAGENAMEE}}|stableid=$1}} gsichteti Version] vu däre Syte, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} frejgee] am <i>$2</i>, basiert uf däre Version.',
...
$messages['mk'] = array(
	...
	'review-logentry-app' => 'оценето [[$1]]',
	'review-logentry-id' => 'ID на ревизија: $1',
...
Проверете ја URL адресата што ја користевте за пристап до оваа страница.',
	'right-autopatrolother' => 'Автоматско означување на ревизии како патролирани во именски простори различни од главниот именски простор',
