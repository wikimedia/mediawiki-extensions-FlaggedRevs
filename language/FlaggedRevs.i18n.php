...
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} comparar])",
	...
	'revreview-visibility2' => "'''Esta página no tiene una [[{{MediaWiki:Validationpage}}|versión estable]] actualizada; configuraciones de estabilidad de página pueden ser [{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} configuradas].'''",
