...
$messages['ja'] = array(
	...
	'flaggedrevs-prefs-stable' => '規定では常にページの安定版を表示する (存在する場合)',
	...
	'review-logpage' => '査読記録',
	'review-logpagetext' => 'ページの特定版に対する[[{{MediaWiki:Validationpage}}|承認]]状況の変更記録です。承認が済んだページのリストは[[Special:ReviewedPages|査読済みページ一覧]]を参照してください。',
	'reviewer' => '査読者',
	...
	'revreview-basic' => 'これは最新の[[{{MediaWiki:Validationpage}}|採用]]版で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿]には査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3件の変更]があります。',
	'revreview-basic-i' => 'これは最新の[[{{MediaWiki:Validationpage}}|採用]]版で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿]には査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} テンプレートまたは画像の変更]があります。',
...
処理中に、この版で使用されているテンプレートまたは画像に対する処理要求が行われた可能性があります。これは、動的なテンプレートによる異なる画像へのリンク、または変数に依存するテンプレートが利用されていることにより、査読開始時点からページの内容が変更された場合に起こり得ます。ページを再読み込みしてから再度査読を行うと、この問題を解決できます。",
	...
	'revreview-edited' => "'''編集は権限のある利用者がそれを査読した時点で[[{{MediaWiki:Validationpage}}|安定版]]に反映されます。''草稿''を以下に表示します。'''査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $2件の変更]があります。",
...
[[Special:Unreviewedpages|未査読ページ一覧]]を参照してください。',
	...
	'revreview-quality' => 'これは最新の[[{{MediaWiki:Validationpage}}|内容充実]]版で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿]には査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0&editreview=1}} $3件の変更]があります。',
	'revreview-quality-i' => 'これは最新の[[{{MediaWiki:Validationpage}}|内容充実]]版で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿]には査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} テンプレートまたは画像の変更]があります。',
	...
	'revreview-quick-basic' => "'''[[{{MediaWiki:Validationpage}}|採用ページ]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿を見る]]",
	'revreview-quick-basic-old' => "'''[[{{MediaWiki:Validationpage}}|採用ページ]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿を見る]]",
	...
	'revreview-quick-quality' => "'''[[{{MediaWiki:Validationpage}}|内容充実ページ]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿を見る]]",
	'revreview-quick-quality-old' => "'''[[{{MediaWiki:Validationpage}}|内容充実ページ]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 草稿を見る]]",
	...
	'stable-logpagetext' => 'これは[[{{MediaWiki:Validationpage}}|安定版]]設定の変更記録です。安定版を持つページの一覧は[[Special:StablePages|安定ページ一覧]]から見ることができます。',
	...
	'readerfeedback-main' => '評価の対象となるのはコンテンツ・ページのみです。',
...
$messages['pl'] = array(
	...
	'hist-autoreviewed' => '[{{fullurl:$1|stableid=$2}} automatycznie przejrzana]',
