...
قائمة بالصفحات المستقرة يمكن العثور عليها في [[Special:StablePages|قائمة الصفحات المستقرة]].',
	...
	'revreview-filter-level-2' => 'نسخ فائقة',
...
قائمة بالصفحات المستقرة يمكن العثور عليها فى [[Special:StablePages|قائمة الصفحات المستقرة]].',
	...
	'revreview-filter-level-0' => 'نسخ منظورة',
	'revreview-filter-level-1' => 'نسخ جودة',
	'revreview-filter-level-2' => 'النسخ الاصليه',
...
[$3 Kommentare oder Fragen?]",
	...
	'revreview-filter-level-2' => 'Ursprüngliche Version',
...
Aby wótgódnośił wersiju, staj wšykne póla na "njeschwalony".',
	...
	'right-autopatrolother' => 'Wersije zwenka głownego mjenjowego ruma ako doglědowane markěrowaś',
...
Lisćina stabilizěrowanych bokow dajo se w [[Special:StablePages|lisćinje stabilnych bokow]] namakaś.',
	...
	'revreview-filter-level-0' => 'Pśeglědane wersije',
	'revreview-filter-level-1' => 'Kwalitne wersije',
	'revreview-filter-level-2' => 'Spócetne wersije',
...
$messages['fr'] = array(
	...
	'flaggedrevs-prefs-watch' => 'Ajouter les pages que je revois à ma liste de suivi.',
...
Voir la liste [[Special:ReviewedPages|des pages relues]] pour une liste de celles qui sont approuvées.',
	...
	'revreview-basic-i' => 'Voici la dernière version [[{{MediaWiki:Validationpage}}|visualisée]], [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approuvée] sur <i>$2</i>.
...
De nouvelles [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} modifications] peuvent avoir été effectuées.',
	...
	'revreview-blocked' => 'Vous ne pouvez pas réviser cette révision parce que votre compte est bloqué ([$1 détails])',
	'revreview-changed' => "'''L’action demandée n’a pu être accomplie pour cette version de [[:$1|$1]].'''
	
Un modèle ou une image peuvent avoir été demandés alors qu’aucune version précise n’était choisie. Ceci peut survenir si un modèle dynamique opère une transclusion d’une autre image ou d’un modèle dépendant d’une variable qui a changé depuis que vous avez commencé à revoir cette page. Rechargement la page et la revoir de nouveau peut corriger ce problème.",
...
Le ''brouillon'' est visible ci-dessous. [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $2 {{PLURAL:$2|modification attend|modifications attendent}}] une relecture.",
	...
	'revreview-main' => 'Vous devez choisir une version précise à partir du contenu de la page pour réviser.

Voir la [[Special:Unreviewedpages|liste des versions non révisées]].',
...
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Des modifications de modèles ou d’images] nécessitent une relecture.',
	...
	'revreview-quality' => "Ceci est la dernière [[{{MediaWiki:Validationpage}}|version de qualité]], [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approuvée] le ''$2''.
Le [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} brouillon] comporte [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3 {{PLURAL:$3|changement|changements}}] nécessitant une révision.",
...
Le [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} brouillon] comprend des [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} changements de modèle ou d’image] en attente d’approbation.',
	'revreview-quality-old' => 'Ceci est une version de [[{{MediaWiki:Validationpage}}|qualité]] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} voir la liste]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approuvée] le <i>$2</i>.
De nouvelles [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} modifications] peuvent avoir été effectuées.',
	'revreview-quality-same' => "Ceci est la dernière version de [[{{MediaWiki:Validationpage}}|qualité]] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} voir la liste]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approuvée] le ''$2''.",
	...
	'revreview-quick-basic-same' => "'''[[{{MediaWiki:Validationpage}}|Page surveillée]]'''",
	'revreview-quick-invalid' => "'''Numéro de version incorrect'''",
	'revreview-quick-none' => "'''Version actuelle''' (pas de révisions)",
...
Cette page contient une [[{{MediaWiki:Validationpage}}|version stable]] : ses paramètres de stabilité peuvent être [{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} configurés].',
	...
	'right-autopatrolother' => 'Marquer automatiquement comme patrouillées les versions dans les espaces de noms autres que le principal.',
...
Consulter aussi la [[Special:StablePages|liste de pages stables]].',
	...
	'readerfeedback-level-1' => 'Faible',
	'readerfeedback-level-2' => 'Moyen',
	'readerfeedback-level-3' => 'Élevé',
	'readerfeedback-level-4' => 'Excellent',
	'readerfeedback-submit' => 'Soumettre',
	'readerfeedback-main' => 'Seules les pages de contenu peuvent être évaluées.',
	'readerfeedback-success' => "'''Merci d'avoir revu cette page !''' ([$3 Des questions ou des commentaires ?])",
	...
	'revreview-filter-unapproved' => 'Rejeté',
	'revreview-filter-auto' => 'Automatique',
	'revreview-filter-manual' => 'Manuel',
	'revreview-filter-level-0' => 'Versions visualisées',
	'revreview-filter-level-1' => 'Versions de qualité',
	'revreview-filter-level-2' => 'Versions vierges',
	'revreview-statusfilter' => 'Changement de statut :',
...
Unha lista das páxinas estabilizadas pode ser atopada na [[Special:StablePages|lista de páxinas estábeis]].',
	...
	'revreview-filter-level-2' => 'Versións antigas',
	'revreview-statusfilter' => 'Cambio de status:',
	'revreview-typefilter' => 'Tipo:',
	'revreview-tagfilter' => 'Etiqueta:',
	'revreview-reviewlink' => 'revisar',
...
'''Die Vorlage un Dateie sin gänderet wore:'''",
	...
	'right-autopatrolother' => 'Automatischs Markiere vu Versione im Nit-Hauptnamensruum as "vum Fäldhieter gsäh"',
...
[$3 Kommentar oder Froge?]",
	...
	'revreview-filter-level-0' => 'Vum Fäldhieter aagluegti Versione',
	'revreview-filter-level-1' => 'Priefti Versione',
	'revreview-filter-level-2' => 'Reini Versione',
...
ראו גם את [[Special:StablePages|רשימת הדפים היציבים]].',
	...
	'revreview-filter-level-0' => 'נצפו',
	'revreview-filter-level-1' => 'איכותיות',
	'revreview-filter-level-2' => 'טהורות',
...
Lisćinu stabilizowanych stronow namakaš w [[Special:StablePages|lisćinje stabilnych stronow]].',
	...
	'revreview-filter-level-1' => 'Kwalitne wersije',
	'revreview-filter-level-2' => 'Prěnjotne wersije',
	'revreview-statusfilter' => 'Změnjenje statusa:',
	'revreview-typefilter' => 'Typ:',
...
$messages['ja'] = array(
	'editor' => '編集者',
	'flaggedrevs' => '特定版の判定',
	'flaggedrevs-backlog' => "未処理の[[Special:OldReviewedPages|古くなった査読済みページ]]があります。'''あなたの注目が必要とされています！'''",
	'flaggedrevs-desc' => '編集者および査読者に、特定版の査読や表示ページとしての採択ができる機能を提供する',
	'flaggedrevs-pref-UI-0' => '安定度表示に詳細なユーザーインタフェースを使用する',
	'flaggedrevs-pref-UI-1' => '安定度表示に単純なユーザーインタフェースを使用する',
	'flaggedrevs-prefs' => '安定度',
	'flaggedrevs-prefs-stable' => '規定では常に記事の安定版を表示する (存在する場合)',
	...
	'revreview-basic' => 'これは最新の[[{{MediaWiki:Validationpage}}|採用]]版で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 採用候補]には査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $3件の変更]があります。',
	'revreview-basic-i' => 'これは最新の[[{{MediaWiki:Validationpage}}|採用]]版で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 採用候補]には査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} テンプレートまたは画像の変更]があります。',
	'revreview-basic-old' => 'これは[[{{MediaWiki:Validationpage}}|採用]]版 ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。新しい[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} 変更]があった可能性もあります。',
	...
	'revreview-basic-source' => '<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認された]このページの[{{fullurl:{{FULLPAGENAMEE}}|stableid=$1}} 採用版]は、この版に基づいています。',
	'revreview-blocked' => 'あなたはアカウントが現在ブロックされているため ([$1 詳細])、この版を査読できません',
	'revreview-changed' => "'''この [[:$1|$1]] の特定版に対する査読は処理されませんでした'''

処理中に、この版で使用されているテンプレートまたは画像に対する処理要求が行われた可能性があります。これは、動的なテンプレートによる異なる画像へのリンク、または変数に依存するテンプレートが利用されていることにより、査読開始時点からページの内容が変更された場合に起こり得ます。ページを再読み込みしてから再度査読を行うと、この問題を解決できます。",
	...
	'revreview-editnotice' => "'''このページへの編集は権限のある利用者がそれを査読した時点で[[{{MediaWiki:Validationpage}}|安定版]]に反映されます。'''",
	'revreview-flag' => 'この特定版の査読',
	'revreview-edited' => "'''編集は権限のある利用者がそれを査読した時点で[[{{MediaWiki:Validationpage}}|安定版]]に反映されます。''採用候補''を以下に表示します。'''査読待ちの[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} $2件の変更]があります。",
...
[[Special:Unreviewedpages|未査読ページ一覧]]を参照してください。',
	'revreview-newest-basic' => '[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} 最新の採用版] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) は <i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。査読が必要な[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0&editreview=1}} $3件の変更]があります。',
	'revreview-newest-basic-i' => '[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} 最新の採用版] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) は <i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。査読が必要な[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} テンプレートまたは画像の変更]があります。',
	'revreview-newest-quality' => '[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} 最新の内容充実版] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) は <i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。査読が必要な[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0&editreview=1}} $3件の変更]があります。',
	'revreview-newest-quality-i' => '[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} 最新の内容充実版] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) は <i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。査読が必要な[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} テンプレートまたは画像の変更]があります。',
	'revreview-noflagged' => "このページには査読済の版がない、すなわち[[{{MediaWiki:Validationpage}}|検査]]されて'''いない'''ため内容は保証できません。",
	...
	'revreview-quality-old' => 'これは[[{{MediaWiki:Validationpage}}|内容充実]]版 ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。新しい[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} 変更]があった可能性もあります。',
	'revreview-quality-same' => 'これは最新の[[{{MediaWiki:Validationpage}}|内容充実]]版 ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} 全一覧]) で、<i>$2</i> に[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認されました]。',
	...
	'revreview-quality-title' => '品質充実ページ',
	'revreview-quick-basic' => "'''[[{{MediaWiki:Validationpage}}|採用ページ]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 採用候補を見る]]",
	'revreview-quick-basic-old' => "'''[[{{MediaWiki:Validationpage}}|採用ページ]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} 採用候補を見る]]",
	'revreview-quick-basic-same' => "'''[[{{MediaWiki:Validationpage}}|採用ページ]]'''",
	...
	'revreview-stable-title' => '採用済みページ',
	'revreview-stable1' => '[{{fullurl:$1|stableid=$2}} この判定済み版]を閲覧し、このページの現在の[{{fullurl:$1|stable=1}} 安定版]であるか確認することができます。',
	'revreview-stable2' => 'このページの[{{fullurl:$1|stable=1}} 安定版]を閲覧することができます (存在する場合)。',
	...
	'revreview-successful' => "'''[[:$1|$1]] の特定版の判定に成功しました。([{{fullurl:Special:Stableversions|page=$2}} 安定版を閲覧])'''",
	'revreview-successful2' => "'''[[:$1|$1]] の特定版の判定取り消しに成功しました。'''",
	'revreview-text' => "''閲覧者に既定で表示されるのは最新版ではなく[[{{MediaWiki:Validationpage}}|安定版]]です。''",
	'revreview-text2' => "''[[{{MediaWiki:Validationpage}}|安定版]]はページの検査済みの版であり、閲覧者に既定で表示する内容として設定できます。''",
	'revreview-toggle-title' => '詳細を表示または非表示',
	'revreview-toolow' => 'ある版を査読済みとするには、以下に示す全ての判定要素を「論外」より高い評価にする必要があります。棄却する場合、全ての評価を「論外」としてください。',
	'revreview-update' => "安定版の[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認]以降になされた変更 (''下記参照'') を[[{{MediaWiki:Validationpage}}|査読]]してください。<br />'''更新されたテンプレートや画像があります:'''",
	'revreview-update-includes' => "'''更新されたテンプレートや画像があります:'''",
	'revreview-update-none' => "安定版の[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} 承認]以降になされた変更 (''下記参照'') を[[{{MediaWiki:Validationpage}}|査読]]してください。",
	'revreview-update-use' => "'''注:''' これらのテンプレートや画像に安定版があれば、それはこのページの安定版で利用されています。",
	...
	'right-autopatrolother' => '標準名前空間以外で特定版を自動的にパトロール済みとマークする',
	'right-autoreview' => '特定版を自動的に採択する',
	'right-movestable' => '安定ページを移動する',
	'right-review' => '特定版を採択する',
	'right-stablesettings' => '安定版がどのように選択され、表示されるのか設定する',
	'right-validate' => '特定版を判定済みとしてマークする',
	...
	'stable-logpagetext' => 'これは記事の[[{{MediaWiki:Validationpage}}|安定版]]設定の変更記録です。安定版を持つページの一覧は[[Special:StablePages|安定ページ一覧]]から見ることができます。',
	'readerfeedback' => 'このページをどう思いますか',
	'readerfeedback-text' => "''少し時間を割いて、このページを評価してください。あなたの貴重なフィードバックが私たちのウェブサイトの改善に役立ちます。''",
	...
	'readerfeedback-level-1' => '低',
	'readerfeedback-level-2' => '可',
	'readerfeedback-level-3' => '高',
	'readerfeedback-level-4' => '優',
	'readerfeedback-submit' => '送信',
	'readerfeedback-main' => '評価の対象となるのは記事のみです。',
	'readerfeedback-success' => "'''このページを評価してくださり、ありがとうございます！'''([$3 意見か質問がありますか？])",
	'readerfeedback-voted' => "'''あなたは既にこのページの評価を済ましているようです。'''([$3 意見か質問がありますか？])",
	...
	'revreview-filter-level-0' => '採用版',
	'revreview-filter-level-1' => '内容充実版',
	'revreview-filter-level-2' => '原始版',
	...
	'tooltip-ca-stable' => 'このページの安定版を見る',
...
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} 비교])",
	...
	'right-autopatrolother' => '일반 문서가 아닌 이름공간에서의 자신의 편집을 검토한 것으로 표시',
...
[$3 Opmerkingen of vragen?]",
	...
	'revreview-filter-level-2' => 'Ongerepte versies',
...
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&diffonly=0}} Mal- eller biletendringar] må verta vurderte.',
	...
	'revreview-patrolled' => 'Den valde versjonen av [[:$1|$1]] har vorten merka som patruljert.',
...
'''Nokre malar eller bilete vart oppdaterte:'''",
	...
	'right-autopatrolother' => 'Automatisk merkja siderversjonar i namneromma utanom hovudnamerommet som patruljerte',
...
Ei lista over stabiliserte sider finst på [[Special:StablePages|lista over stabile sider]].',
	...
	'revreview-filter-level-0' => 'Vurderte versjonar',
	'revreview-filter-level-1' => 'Kvalitetsversjonar',
	'revreview-filter-level-2' => 'Urørde versjonar',
...
'''Qualques imatges o modèls son estats meses a jorn :'''",
	...
	'revreview-filter-level-2' => 'Versions vèrjas',
...
Zobacz również [[Special:StablePages|listę skonfigurowanych stron]].',
	...
	'revreview-filter-level-2' => 'nienaruszone wersje',
...
Uma lista de páginas com conteúdo estabilizado pode ser encontrada na [[Special:StablePages|lista de páginas estáveis]].',
	...
	'revreview-filter-level-2' => 'Versões intocadas',
...
Vide 'a [[Special:Unreviewedpages|liste de le pàggene ca non g'onne state rivisitete]].",
	...
	'revreview-filter-level-2' => 'Ripristine de le versiune',
...
См. также  [[Special:StablePages|список стабильных страниц]].',
	...
	'revreview-filter-level-2' => 'Нетронутых',
...
Môžete si pozrieť [[Special:StablePages|Zoznam stabilných stránok]].',
	...
	'revreview-filter-level-2' => 'Čisté verzie',
...
En lista över stabiliserade sidor kan hittas på [[Special:StablePages|listan över stabila sidor]].',
	...
	'revreview-filter-level-2' => 'Ursprungliga versioner',
...
Matatagpuan ang isang talaan ng napatatag na mga pahina mula sa [[Special:StablePages|talaan ng matatag na pahina]].',
	...
	'revreview-filter-level-2' => 'Mga bersyong nasa orihinal na kalagayan',
...
'''Bazı şablonlar/resimler güncellenmiş:'''",
	...
	'right-autopatrolother' => 'Revizyonları, ana ad alanları dışında otomatik olarak gözlenmiş olarak işaretle',
...
Kararlı sayfaları, [[Special:StablePages|kararlı sayfa listesinde]] bulabilirsiniz.',
	...
	'revreview-filter-level-0' => 'Gözlenmiş sürümler',
	'revreview-filter-level-1' => 'Kaliteli sürümler',
	'revreview-filter-level-2' => 'Asıl sürümler',
