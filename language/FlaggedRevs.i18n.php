...
Appears on top of the protection form when the page has no stable varsion.',
...
$messages['ja'] = array(
	...
	'review-logpage' => '査読記録',
	'review-logpagetext' => 'ページの版に対する[[{{MediaWiki:Validationpage}}|承認]]状況の変更記録です。承認が済んだページのリストは[[Special:ReviewedPages|査読済みページ一覧]]を参照してください。',
	'reviewer' => '査読者',
...
[[Special:Unreviewedpages|未査読ページ一覧]]を参照してください。',
	...
	'revreview-noflagged' => "このページには査読済みの版がない、すなわち品質が[[{{MediaWiki:Validationpage}}|検査]]されて'''いない'''かもしれません。",
