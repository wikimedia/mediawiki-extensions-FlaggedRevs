...
「安定版の選択」設定を、内容充実もしくは原始版を既定で使用するよう変更するさい、ページに該当する版が実際に存在することを確認してください。存在しない場合、設定の意味はほぼありません。",
	...
	'stabilization-select2' => '判定レベルによらない、最新の査読済版',
...
Po zmianie sposobu ''wyboru wersji oznaczonej'' aby korzystała domyślnie z wersji „wysokiej jakości” lub „dziewiczej” należy się upewnić, że strona posiada tego typu wersje, w przeciwnym wypadku zmiana przyniesie niewielki skutek.",
