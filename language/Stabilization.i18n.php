...
Моментални нагодувања за [[:$1|$1]]:',
	...
	'stabilization-select2' => 'Последната прегледана ревизија, со оглед на нивото на потврдување',
	...
	'stabilization-def1' => 'Стабилната ревизија; ако не постои, тогаш моменталната/нацртната',
	'stabilization-def2' => 'Моментална/нацртна верзија',
