...
Калі ласка, прарэцэнзуйце ўсе зьмены пададзеныя ніжэй, каб Вашыя рэдагаваньні былі далучаныя да стабільнай вэрсіі.',
	...
	'revreview-reject-text-list' => "Выканаўшы гэтае дзеяньне, Вы '''адхіліце''' зьмены крынічнага тэксту ў {{PLURAL:$1|1=наступнай зьмене|наступных зьменах}} [[:$2|$2]]:", # Fuzzy
...
$messages['bn'] = array(
	...
	'revreview-reflag' => 'এই সংশোধনটি পুনঃ পর্যালোচনা করুন',
...
$messages['ca'] = array(
	...
	'review_not_flagged' => 'La revisió de destinació actualment no està marcada com a revisada.',
	'review_too_low' => 'No es pot verificar la revisió amb alguns camps deixats com a « insuficients ».',
	'review_bad_tags' => "Alguns dels valors de l'etiqueta especificada no són vàlids.",
	...
	'revreview-successful2' => "'''S'ha depreciat amb èxit la revisió de [[:$1|$1]].'''",
...
$messages['ce'] = array(
	...
	'review_no_oldid' => 'Ца хоттийна ID верси.',
	'review_bad_oldid' => 'Йоцуш ю ишта Ӏалаше хьажийна верси.',
	'review_conflict_oldid' => 'Хьо цуьнга хьожушехь, цхьаммо къобал йина, я къобал яра дӀадаьккхина кху верси.',
	'review_not_flagged' => 'Iалаше хьажийна верси хьаьжин санна билгал ца йина.',
	...
	'revreview-check-flag-p' => 'Къобал йой хӀара верси ($1 {{PLURAL:$1|1=хьажанза хийцам|хьажанза хийцамаш}})', # Fuzzy
	...
	'revreview-check-flag-u' => 'Къобал йе хӀара верси хьажанза агӀон',
	'revreview-check-flag-u-title' => 'Къобал йе хӀара агӀон верси. Лела йе, нагахьсан хьо билгалла хьаьжнехь агӀоне.',
	...
	'revreview-invalid' => "'''ГӀалатца хьажор:''' йоцуш ю [[{{MediaWiki:Validationpage}}|хьаьжна]] йогӀуш йолу оцу цӀарца агӀонан верси.",
...
Vidu la [[Special:Unreviewedpages|liston de nereviziitaj paĝoj]] .',
	...
	'revreview-adv-reviewing-p' => 'Notu: aliaj reviziantoj povas vidi ke {{GENDER:$1|vi}} revizias ĉi tiun paĝon.',
	'revreview-adv-reviewing-c' => 'Notu: aliaj reviziantoj povas vidi ke {{GENDER:$1|vi}} revizias ĉi tiujn ŝanĝojn.',
...
$messages['es'] = array(
	...
	'review_page_invalid' => 'El título de página de destino no es válido.',
...
$messages['fa'] = array(
	...
	'revreview-check-flag-y' => 'تغییرات من را قبول کن',
...
Vous devez relire toutes les modifications affichées ci-dessous pour la votre apparaisse dans la version stable.',
	...
	'revreview-reject-summary-cur' => '{{PLURAL:$1|La dernière modification du texte|Les dernières modifications du texte}} (par $2) {{PLURAL:$1|a été rejetée|ont été rejetées}} et la version $3 de $4 a été restaurée',
	...
	'revreview-reject-summary-cur-short' => '{{PLURAL:$1|La dernière modification du texte a été rejetée|Les $1 dernières modifications du texte ont été rejetées}} et la version $2 de $3 a été restaurée',
...
נא לסקור את כל השינויים המופיעים להלן כדי שהעריכות שלך תופענה בגרסה היציבה.',
	'revreview-update-edited-prev' => '<span class="flaggedrevs_important">השינויים שלך עדיין אינם בגרסה היציבה. יש שינויים קודמים שממתינים לסקירה.</span>
...
Sjá nánar á [[Special:Unreviewedpages|lista yfir óskoðaðar síður]].',
	...
	'revreview-reject-summary-cur' => 'Hafnaði síðustu $1 {{PLURAL:$1|breytingu|breytingum}} (eftir $2) og breytti aftur til útgáfu $3 eftir $4',
	'revreview-reject-summary-cur-short' => 'Hafnaði síðustu $1 {{PLURAL:$1|breytingu|breytingum}} og breytti aftur til útgáfu $2 eftir $3',
...
$messages['mr'] = array(
	...
	'revreview-failed' => '"या आवृत्तीचे पुनरावलोकन संभव नाही."',
	'revreview-submission-invalid' => 'सादरीकरण अपूर्ण होते किंवा बहुदा अवैध.',
	'review_page_invalid' => 'लक्ष्य पानाचे शीर्षक अवैध आहे.',
	'review_page_notexists' => 'लक्ष्य पान अस्तित्वात नाही.',
	'review_page_unreviewable' => 'लक्ष्य पान पुनरावलोकन करण्याजोगे नाही.',
	'review_no_oldid' => 'आवृत्ती ओळखण नमूद नाही.',
	'review_bad_oldid' => 'लक्ष्य आवृत्ती अस्तित्वात नाही.',
	'review_conflict_oldid' => 'आपण ती बघत असतांना, कोणीतरी पूर्वीच ही आवृत्ती स्वीकृत अथवा अस्वीकृत केलेली आहे.',
	'review_not_flagged' => "लक्ष्य आवृत्तीवर सध्या 'पुनरावलोकित' म्हणून खूण केलेली नाही.",
	'review_too_low' => 'काही क्षेत्रे "अपर्याप्त" ठेउन आवृत्ती पुनरावलोकित केल्या जाउ शकत नाही.',
	'review_bad_key' => 'अवैध अंतर्भावित प्राचल कळ',
	'review_bad_tags' => 'नमूद केलेल्या काही खूणांकित किंमती अवैध आहेत.',
	'review_denied' => 'परवानगी नाकारण्यात येते.',
	'review_param_missing' => 'प्राचल अनुपलब्ध किंवा अवैध आहे.',
	'review_cannot_undo' => 'हे बदल पुर्ववत केल्या जाउ शकत नाही कारण पुढील प्रलंबित संपादनांने नेमके तेच क्षेत्र बदलले आहे.',
	'review_cannot_reject' => 'हे बदल अस्वीकार करता येणार नाही कारण कोणीतरी त्यातील काही (अथवा सर्व) बदल स्वीकारले आहेत.',
	'review_reject_excessive' => 'एवढे बदल एकदम अस्वीकार करता येउ शकत नाही.',
	'review_reject_nulledits' => 'हे बदल अस्वीकार करता येणार नाही कारण सर्व आवृत्त्या ह्या रिक्त आहेत.',
	'revreview-check-flag-p' => 'ही आवृत्ती स्वीकारा (ज्यात $1 प्रलंबित बदल {{PLURAL:$1|बदल आहेत}})',
	'revreview-check-flag-p-title' => 'आपण केलेले बदल व प्रलंबित बदल असलेले निकाल स्वीकारा. आपण सर्व प्रलंबित बदलांचा फरक बघितला असेल तरच, फक्त याचा वापर करा.',
	'revreview-check-flag-u' => 'या अपुनरावलोकित पानाचा स्वीकार करा',
	'revreview-check-flag-u-title' => 'पानाच्या या आवृत्तीचा स्वीकार करा.हे पान पूर्णपणे बघितले असेल, फक्त तरच, याचा वापर करा.',
	'revreview-check-flag-y' => 'माझे बदल स्वीकारा',
	'revreview-check-flag-y-title' => 'आपण येथे केलेले सर्व बदल स्वीकारा.',
	'revreview-flag' => 'ही आवृत्ती तपासा',
	'revreview-reflag' => 'या आवृत्तीचे पुनर्-पुनरावलोकन करा',
	'revreview-invalid' => "'''चुकीचे लक्ष्य:''' कुठलीही [[{{MediaWiki:Validationpage}}|तपासलेली]] आवृत्ती दिलेल्या क्रमांकाशी जुळत नाही.",
	'revreview-log' => 'शेरा:',
	'revreview-main' => 'पुनरावलोकनासाठी आशयपानाची एखादी विशिष्ट आवृत्ती निवडणे गरजेचे आहे.
[[Special:Unreviewedpages|अपुनरावलोकित पानांची यादी]] बघा.',
	'revreview-stable1' => 'तुम्ही कदाचित या पानाची [{{fullurl:$1|stableid=$2}}ही खूण केलेली आवृत्ती]  
बघायची असेल व हेही बघा कि ती सध्या या पानाची [{{fullurl:$1|stable=1}} स्थिर आवृत्ती] झाली आहे.',
	'revreview-stable2' => 'तुम्ही या पानाची [{{fullurl:$1|stable=1}} स्थिर आवृत्ती] पाहू इच्छित असाल.',
	'revreview-submit' => 'सादर करा',
	'revreview-submitting' => 'सादर करीत आहे...',
	'revreview-submit-review' => 'आवृत्ती स्वीकारा',
	'revreview-submit-unreview' => 'आवृत्तीचा अस्वीकार करा',
	'revreview-submit-reject' => 'बदल अस्वीकार करा',
	'revreview-submit-reviewed' => 'झाले.स्वीकार केला!',
	'revreview-submit-unreviewed' => 'झाले.अस्वीकार केला!',
...
([{{fullurl:{{#Special:ReviewedVersions}}|page=$2}} सर्व खूणा केलेल्या आवृत्त्या पहा])'''",
	...
	'revreview-poss-conflict-p' => "'''ईशारा:$3 येथे $2 वर [[User:$1|$1]] या पानाचे पुनरावलोकन करीत आहे.'''",
	'revreview-poss-conflict-c' => "'''ईशारा:$3 येथे $2 वर [[User:$1|$1]] या पानाच्या बदलांचे पुनरावलोकन करीत आहे.'''",
	'revreview-adv-reviewing-p' => 'सूचना:इतर तपासणी करणारे हे बघु शकतात कि {{GENDER:$1|आपण}} या पानाचे पुनरावलोकन करीत आहात.',
	'revreview-adv-reviewing-c' => 'सूचना:इतर तपासणी करणारे हे बघु शकतात कि {{GENDER:$1|आपण}} या पानातील बदलांचे पुनरावलोकन करीत आहात.',
	'revreview-sadv-reviewing-p' => 'आपण इतर सदस्यांना, स्वतःस $1 करू शकता कि आपण या पानाचे पुनरावलोकन करीत आहे.',
	'revreview-sadv-reviewing-c' => 'आपण इतर सदस्यांना, स्वतःस $1 करू शकता कि आपण या बदलांचे पुनरावलोकन करीत आहे.',
	'revreview-adv-start-link' => 'जाहिरात करा',
	'revreview-adv-stop-link' => 'जाहिरातीपासून विलग',
	'revreview-toolow' => 'एखादी आवृत्ती तपासलेली आहे अशी खूण करण्यासाठी तुम्ही खालील प्रत्येक पॅरॅमीटर्सना "अपर्याप्त" पेक्षा वरचा दर्जा देणे आवश्यक आहे.

एखाद्या आवृत्तीची \'पुनरावलोकन\' स्थिती हटविण्यासाठी,"{{int:revreview-submit-unreview}}" वर टिचका.

कृपया आपल्या न्याहाळकाच्या  "back"  कळीवर टिचकून पुन्हा प्रयत्न करा.',
	'revreview-update' => "'''कृपया,या स्थिर आवृत्तीनंतर झालेले ''(खाली दर्शविलेले)'' प्रलंबित बदल  [[{{MediaWiki:Validationpage}}|पुनरावलोकित करा]]. '''",
	'revreview-update-edited' => '<span class="flaggedrevs_important">आपले बदल अद्याप स्थिर आवृत्तीत आलेले नाहीत.</span>

कृपया,आपली संपादने स्थिर आवृत्तीत दिसण्यास, खाली दर्शविलेले सर्व बदल पुनरावलोकित करा.',
	'revreview-update-edited-prev' => '<span class="flaggedrevs_important">आपले बदल अद्याप स्थिर आवृत्तीत आलेले नाहीत.हे पूर्वीचे अपुनरावलोकित बदल आहेत.</span>

कृपया,आपली संपादने स्थिर आवृत्तीत दिसण्यास, खाली दर्शविलेले सर्व बदल पुनरावलोकित करा.',
	'revreview-update-includes' => 'साचे/चित्रे अद्यतन करण्यात आलेली आहेत. (अपुनरावलोकित पाने ठळक अक्षरात आहेत):',
	'revreview-reject-summary' => 'तपशील:',
	'revreview-reject-confirm' => 'हे बदल अस्वीकृत करा',
	'revreview-reject-cancel' => 'रद्द करा',
);
...
Чтобы включить ваши правки в стабильную версию, пожалуйста, проверьте все изменения, показанные ниже.',
	...
	'revreview-reject-text-list' => "Выполняя это действие, вы '''отвергаете''' изменение исходного текста в {{PLURAL:$1|1=следующей версии|следующих версиях}} страницы «[[:$2|$2]]»:",
	...
	'revreview-reject-summary-old-short' => '{{PLURAL:$1|Отклонено первое $1 текстовое изменение|Отклонены первые $1 текстовых изменений|Отклонены первые $1 текстовых изменения|1=Отклонено первое текстовое изменение}}, {{PLURAL:$1|1=следовавшее|следовавшие}} за версией $2 $3',
...
[[Special:Unreviewedpages|İncelenmemiş sayfalar listesine]] göz atın.',
	...
	'revreview-adv-reviewing-p' => 'Bilgi: Diğer kullanıcılar bu değişikliği {{GENDER:$1|incelediğinizi}} görebilirler.',
	'revreview-adv-reviewing-c' => 'Bilgi: Diğer kullanıcılar bu değişiklikleri {{GENDER:$1|incelediğinizi}} görebilirler.',
...
Будь ласка, перевірте усі зміни, наведені нижче, щоб включити ваші редагування до стабільної версії.',
	...
	'revreview-reject-text-list' => "Виконуючи цю дію, ви '''відкидаєте''' зміну вихідного коду в {{PLURAL:$1|1=наступній редакції|наступних редакціях}} [[:$2|$2]] :",
	...
	'revreview-reject-summary-old' => '{{PLURAL:$1|Скасовано перше редагування|Скасовані перші $1 редагування|Скасовані перші $1 редагувань}} (користувача $2), {{PLURAL:$1|1=виконане|виконані}} після версії $3 $4',
	...
	'revreview-reject-summary-old-short' => '{{PLURAL:$1|Скасовано перше редагування|Скасовані перші $1 редагування|Скасовані перші $1 редагувань}}, {{PLURAL:$1|1=наступне|наступні}} за версією $2 $3',
