...
Παρακαλώ επιθεωρήστε όλες τις αλλαγές που φαίνονται παρακάτω για να κάνετε τις αλλαγές σας να εμφανιστούν στην σταθερή έκδοση.',
	...
	'revreview-reject-summary-cur' => '{{PLURAL:$1|Απορρίφθηκε η τελευταία αλλαγή|Απορρίφθηκαν οι $1 τελευταίες αλλαγές}} (από $2) κειμένου και αποκαταστάθηκε η αναθεώρηση $2 από $3', # Fuzzy
