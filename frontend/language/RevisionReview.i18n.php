...
იხილეთ [[Special:Unreviewedpages|შეუმოწმებელი გვერდების სია]].',
	...
	'revreview-update-includes' => 'ზოგიერთი თარგი ან ფაილი განახლდა:',
...
См. [[Special:Unreviewedpages|список непроверенных страниц]].',
	...
	'revreview-adv-reviewing-p' => 'Предупреждение. Другие рецензенты могут видеть, что вы проверяете эту страницу.',
	'revreview-adv-reviewing-c' => 'Предупреждение. Другие рецензенты могут видеть, что вы проверяете эти изменения.',
