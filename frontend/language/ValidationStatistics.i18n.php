...
Гэтыя старонкі лічацца ''састарэлымі''. Старонкі лічацца ''сінхранізаванымі'', калі няма правак, якія чакаюць праверкі.", # Fuzzy
	'validationstatistics-revtime' => "Сярэдняя затрымка праверкі для правак, якія зрабілі ''ўдзельнікі, якія не прадставіліся'', складае '''$1'''; медыяна — '''$2'''.
$3",
...
An dale keitat evit [[Special:OldReviewedPages|ar pajennoù a c'hortoz bezañ adlennet]] a sav da '''$1'''; Muzuliañ a ra an termen pegen pell eo chomet ar c'hemm diwezhañ hep bezañ gwiriet.", # Fuzzy
...
\$3",
	'validationstatistics-table' => "A-is emañ diskouezet ar stadegoù adwelout evit pep esaouenn anv, ''nemet'' evit ar pajennoù adkas. Sellet a reer ouzh ar pajennoù evel ''dispredet'' ma'z eus kemmoù enno a chom da vezañ aprouet; sellet a reer ouzh ar pajennoù evel ''sinkronelaet'' ma n'eus netra enno da vezañ aprouet.", # Fuzzy
	...
	'validationstatistics-unreviewed' => "N'eo ket bet adwelet",
...
Wobźěłowarje su etablěrowane wužiwarje, kótarež mógu wersije bokow pśeglědaś.",
	...
	'validationstatistics-pndtime' => "Změny, kótarež su se pśekontrolěrowali wót  nazgónitych wužywarjow by měli se ''{{int:validationstatistics-stable}}''.

Psérězne wokomuźenje pśeglědanja za [[Special:OldReviewedPages|boki z tuchylu njepśeglědanymi změnami]] jo '''$1''';
...
\$3",
	'validationstatistics-table' => "Statistika pśekontrolěrowanja bokow za kuždy mjenjowy rum pokazujo se dołojce, ''mimo'' dalejpósrědnjenjow. Boki maju za '{{int:validationstatistics-old}}'', jolic maju změny, kótarež cakaju na pśeglědanje; boki maju za '''{{int:validationstatistics-latest}}'', jolic změny, kótarež cakaju na pśeglědanje, njejsu.",
	...
	'validationstatistics-unreviewed' => 'Njepśeglědany',
...
La averaĝa atendo-tempo por [[Special:OldReviewedPages|paĝoj kun kontrolendaj redaktoj]] estas '''$1'''. Ĉi tiu atendo-tempo mezuras tempon ekde la plej malnova kontrolenda redakto estis farita.", # Fuzzy
...
$3",
	'validationstatistics-table' => "Jen statistikoj pri paĝkontrolado por ĉiu nomspaco, ''eksklusivante'' alidirektilojn. Paĝoj estas konsiderataj kiel ''malfreŝaj'' se ili havas kontrolendajn redaktojn. Paĝoj estas konsiderataj kiel ''ĝisdataj'' se ne estas kontrolendaj redaktoj.", # Fuzzy
	...
	'validationstatistics-unreviewed' => 'Nekontrolita',
...
La demora mide cuanto la edición pendiente más antigua ha estado sin revisar.", # Fuzzy
	...
	'validationstatistics-unreviewed' => 'Sin revisar',
...
Gli editori sono utenti stabili che possono convalidare le revisioni nelle pagine",
	...
	'validationstatistics-pndtime' => "Le modifiche che sono state controllate da utenti affidabili sono considerate ''{{int:validationstatistics-stable}}''.
...
Skribenter är etablerade användare som kan granska sidversioner.",
	...
	'validationstatistics-pndtime' => "Redigeringar som har kollats av etablerade användare anses vara ''{{int:validationstatistics-stable}}''.

Den genomsnittliga förseningen för [[Special:OldReviewedPages|sidor med aktuella ogranskade redigeringar]] är '''$1'''; dröjsmålet mäter hur lång tid den äldsta väntande redigeringen blivit granskad.",
...
Sidor behandlas som ''{{int:validationstatistics-old}}'' om de har redigeringar i väntan på granskning;
sidor betraktas som ''{{int:validationstatistics-latest}}'' om det inte finns några redigeringar i väntan på granskning.",
