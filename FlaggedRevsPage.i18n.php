 ...
 */
$messages['el'] = array(
	'flaggedrevs-desc'          => 'Δίνει τη δυνατότητα στους επεξεργαστές και τους επανεξεταστές να αναγνωρίσουν επαναλήψεις και να σταθεροποιήσουν σελίδες',
	'editor'                    => 'Επεξεργαστής',
	'group-editor'              => 'Επεξεργαστές',
	'group-editor-member'       => 'Επεξεργαστής',
	'grouppage-editor'          => '{{ns:project}}:Επεξεργαστής',
	...
	'revreview-current'         => 'Σχέδιο',
	'tooltip-ca-current'        => 'Δείτε το υπάρχον σχέδιο για αυτή τη σελίδα',
	'revreview-edit'            => 'Επεξεργασία σχεδίου',
	'revreview-source'          => 'πηγή σχεδίου',
	'revreview-stable'          => 'Σταθερό',
	'revreview-oldrating'       => 'Βαθμολογήθηκε:',
	'stabilization-tab'         => 'εξωνυχιστικός έλεγχος',
	'revreview-quick-invalid'   => "'''Λάθος επανάληψη ταυτότητας'''",
	...
	'hist-stable'               => 'θεάσιμη επανάληψη',
	'hist-quality'              => 'έκδοση ποιότητας',
	'review-logentry-app'       => 'αναθεωρημένο [[$1]]',
	'stable-logpage'            => 'Σταθερή έκδοση αρχείου καταγραφών',
	'revreview-patrol'          => 'Μάρκαρε αυτήν την αλλαγή ως υπο περιπολία',
	'revisionreview'            => 'Αναθεώρηση επαναλήψεων',
	'revreview-selected'        => "Επιλεγμένη επανάληψη του '''$1:'''",
	'revreview-flag'            => 'Αναθεώρησε αυτήν την επανάληψη',
	'revreview-legend'          => 'Βαθμολόγησε το περιεχόμενο της επανάληψης',
...
$messages['nl'] = array(
	...
	'revreview-quick-see-quality'  => "'''Werkversie''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} pagina bekijken]]
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} vergelijken])",
	'revreview-quick-see-basic'    => "'''Werkversie''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} pagina bekijken]]
([{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} vergelijken])",
	'revreview-quick-basic'        => "'''[[{{MediaWiki:Validationpage}}|Beoordeelde pagina]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} werkversie bekijken]]",
	'revreview-quick-quality'      => "'''[[{{MediaWiki:Validationpage}}|Kwaliteitsversie]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} werkversie bekijken]]",
	'revreview-quick-basic-old'    => "'''[[{{MediaWiki:Validationpage}}|Beoordeeld artikel]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} werkversie bekijken]]",
	'revreview-quick-quality-old'  => "'''[[{{MediaWiki:Validationpage}}|Kwaliteitspagina]]''' [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} werkversie bekijken]]",
	'revreview-quick-basic-same'   => "'''[[{{MediaWiki:Validationpage}}|Beoordeelde pagina]]'''",
...
[{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} $3 {{plural:$3|versie|versies}}] {{plural:$3|heeft|hebben}} eindredactie nodig.',
	'revreview-basic'              => 'Dit is de laatst [[{{MediaWiki:Validationpage}}|beoordeelde]] versie, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} gekeurd] op <i>$2</i>.
U kunt de [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} werkversie] [{{fullurl:{{FULLPAGENAMEE}}|action=edit}} bewerken]; [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} $3 {{plural:$3|versie|versies}}] {{plural:$3|wacht|wachten}} op eindredactie.',
	'revreview-quality'            => 'Dit is de laatste [[{{MediaWiki:Validationpage}}|kwaliteitsversie]], [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} gekeurd] op <i>$2</i>.
U kunt de [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} werkversie] [{{fullurl:{{FULLPAGENAMEE}}|action=edit}} bewerken]; [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} $3 {{plural:$3|versie|versies}}] {{plural:$3|wacht|wachten}} op eindredactie.',
	'revreview-basic-same'         => "Dit is de laatste [[{{MediaWiki:Validationpage}}|beoordeelde]] versie ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} allemaal bekijken]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} goedgekeurd] op <i>$2</i>.
...
U kunt de pagina '''[{{fullurl:{{FULLPAGENAMEE}}|action=edit}} bewerken]'''.",
	'revreview-basic-old'          => 'Dit is een [[{{MediaWiki:Validationpage}}|beoordeelde]] versie ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} alles bekijken]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} gekeurd] op <i>$2</i>.
Er kunnen nieuwe [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} wijzigingen] gemaakt zijn.',
	'revreview-quality-old'        => 'Dit is een [[{{MediaWiki:Validationpage}}|kwaliteitsversie]] ([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} alles bekijken]), [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} gekeurd] op <i>$2</i>.
Er kunnen nieuwe [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur}} wijzigingen] gemaakt zijn.',
	...
	'revreview-basic-source'       => 'Een [{{fullurl:{{FULLPAGENAMEE}}|stableid=$1}} beoordeelde versie] van deze pagina, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} gekeurd] op <i>$2</i>, is gebaseerd op deze versie.',
	'revreview-quality-source'     => 'Een [{{fullurl:{{FULLPAGENAMEE}}|stableid=$1}} kwaliteitsversie] van deze pagina, [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} gekeurd] op <i>$2</i>, is gebaseerd op deze versie.',
...
Zie  de [[Special:Unreviewedpages|lijst met pagina's zonder eindredactie]].",
	...
	'revreview-toolow'             => 'U moet tenminste alle onderstaande eigenschappen hoger instellen dan "niet gekeurd" om voor een versie aan te merken geven dat deze eindredactie heeft gehad.
Stel alle velden in op "niet gekeurd" om de waardering van een versie te verwijderen.',
...
als die er niet is, dan de laatste beoordeelde versie',
...
'''Một số tiêu bản/hình ảnh được cập nhật:'''",
	...
	'revreview-auto-w-old'         => "Bạn đang sửa đổi một bản đã duyệt trước đây; những thay đổi sẽ '''tự động được duyệt'''.",
