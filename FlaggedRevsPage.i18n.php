...
[[{{MediaWiki:Validationpage}}|نشده‌است]].',
	...
	'revreview-quick-see-quality'  => "'''پیش‌نویس'''. [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} مشاهده نسخه پایدار]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|تغییر|تغییر}}])",
	'revreview-quick-see-basic'    => "'''پیش‌نویس'''. [[{{fullurl:{{FULLPAGENAMEE}}|stable=1}} مشاهده نسخه پایدار]] 
...
نیازمند بررسی {{plural:$3|است|هستند}}.',
	...
	'revreview-update'             => "لطفاً تمام تغییراتی که از زمان [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} تایید شدن] صفحه اتفاق افتاده‌اند ''(و در پایین نمایش داده شده‌اند)'' را [[{{MediaWiki:Validationpage}}|بررسی کنید]].

'''برخی از الگوها/تصویرها تغییر یافته‌اند:'''",
	'revreview-update-none'        => "لطفاً تمام تغییراتی که از زمان [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} تایید شدن] صفحه اتفاق افتاده‌اند ''(و در پایین نمایش داده شده‌اند)'' را [[{{MediaWiki:Validationpage}}|بررسی کنید]].",
