...
CREATE TABLE flaggedpage_pending (
  fpp_page_id INT NOT NULL,
  fpp_quality SMALLINT NOT NULL,
  fpp_rev_id INT NOT NULL,
  fpp_pending_since TIMESTAMPTZ NOT NULL,
...
CREATE TABLE flaggedtemplates (
  ft_rev_id INT NOT NULL,
  ft_tmp_rev_id INT NOT NULL,
...
CREATE TABLE flaggedrevs_tracking (
  ftr_from INT DEFAULT 0 NOT NULL, ftr_namespace INT DEFAULT 0 NOT NULL,
  ftr_title TEXT DEFAULT '' NOT NULL
);

CREATE UNIQUE INDEX frt_from_namespace_title ON flaggedrevs_tracking (
