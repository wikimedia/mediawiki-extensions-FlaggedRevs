...
$messages['de'] = array(
	...
	'makevalidate-logpagetext'      => 'Dies ist das Änderungs-Logbuch der Benutzer-[[Help:Article validation|Sichter-/Prüf-Rechte]].',
...
$messages['pt'] = array(
	...
	'makevalidate-logpagetext'      => 'Este é um registo de alterações de privilégios de [[{{ns:help}}:Validação de páginas|validadores de páginas]] ([[{{int:grouppage-editor}}|{{int:group-editor}}]] e [[{{int:grouppage-reviewer}}|{{int:group-reviewer}}]]).',
