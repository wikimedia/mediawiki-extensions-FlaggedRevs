...
$messages = array(
	...
	'revreview-quick-basic'     => '\'\'\'[[{{MediaWiki:Makevalidate-page}}|Vue]]\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} voir révision courante]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|modification|modifications}}])',
	'revreview-quick-quality'   => '\'\'\'[[{{MediaWiki:Makevalidate-page}}|Qualité]]\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} voir version courante]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|changement|changements}}])',
	...
	'stable-logpagetext'        => 'C\'est le journal des modifications pour les [[{{MediaWiki:Makevalidate-page}}|version stables]] des pages.',
...
Un modèle ou une image peut avoir été demandé alors qu\'aucune version précise n\'était choisie. Cela peut survenir lorsque qu\'un modèle (ou une image) remplace dynamiquement un autre modèle (ou une autre image) selon une variable qui dépend de la version de la page. Rafraîchir la page et reviser à nouveau celle-ci peut corriger ce problème.',
	...
	'revreview-visibility'      => 'Cette page contient une [[{{MediaWiki:Makevalidate-page}}|version stable]], qui peut être [{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} configurée].',
