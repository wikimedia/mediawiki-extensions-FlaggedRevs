...
$messages = array(
	...
	'grouppage-reviewer'        => '{{ns:project}}:Reviewer',#identical but defined
	...
	'revreview-noflagged'       => 'Il n\'y a pas de version révisée de cette page, sa qualité est incertaine.',
	...
	'revreview-quick-basic'     => '\'\'\'Vue\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} voir révision courante]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|modification|modifications}}])',
	'revreview-quick-quality'   => '\'\'\'Qualité\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} voir version courante]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|changement|changements}}])',
	...
	'review-logpagetext'        => 'C\'est un journal des modifications pour l\'approbation des révisions.',
	...
	'stable-logpagetext'        => 'C\'est le journal des modifications pour les version stables des pages.',
	...
	'revreview-style-1'         => 'Acceptable',#identical but defined
	'revreview-style-2'         => 'Bonne',
	'revreview-style-3'         => 'Concise',#identical but defined
...
Un modèle ou une image peut avoir été demandé alors qu\'aucune version précise n\'était choisie. Cela peut survenir lorsque qu\'un modèle (ou une image) remplace dynamiquement un autre modèle (ou une autre image) selon une variable qui dépend de la version de la page. Rafraîchir la page et reviser à nouveau celle-ci peut corriger ce problème.',
	...
	'review-diff2oldest'        => 'Différence avec la dernière version',
	...
	'revreview-visibility'      => 'Cette page contient une version stable, qui peut être [{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} configurée].',
