...
$messages = array(
	...
	'makereviewer-header'           => '<strong>Det här formuläret används av administratörer och byråkrater för att befordra användare till sidgranskare</strong><br /> 
Skriv användarens namn i rutan  och tryck på knappen för att ändra användarens rättigheter.
Att ge användare granskarstatus ger dem automatiskt också redaktörstatus. Om redaktörstatus tas ifrån användare, så tas samtidigt automatiskt deras granskarstatus ifrån dem.',
