...
$messages = array(
	...
	'revreview-quick-basic'       => "'''[[{{MediaWiki:Validationpage}}|Crítica]]'''. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} ver edição atual]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|alteração|alterações}}])",
	'revreview-quick-quality'     => "'''[[{{MediaWiki:Validationpage}}|Estável]]'''. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} ver edição atual]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|alteração|alterações}}])",
...
Seguem-se as configurações para [[:$1|$1]]:',
	...
	'stabilization-def1'          => 'A edição estável; se inexistente, exibir a edição atual',
