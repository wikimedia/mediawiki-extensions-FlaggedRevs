...
$messages = array( 
	...
	[[{{MediaWiki:Makevalidate-page}}|checked]] for quality.',
	...
	($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|change|changes}}])',
	'revreview-quick-basic' => '\'\'\'[[{{MediaWiki:Makevalidate-page}}|Sighted]]\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} see current revision]] 
	($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|change|changes}}])',
	'revreview-quick-quality' => '\'\'\'[[{{MediaWiki:Makevalidate-page}}|Quality]]\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} see current revision]] 
	($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|change|changes}}])',
	...
	([{{fullurl:Special:Stableversions|page={{FULLPAGENAMEE}}}} list all]) was [{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approved]
	 on <i>$2</i>. [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} $3 {{plural:$3|change|changes}}] {{plural:$3|needs|need}} review.',
	'revreview-basic' => 'This is the latest [[{{MediaWiki:Makevalidate-page}}|sighted]] revision, 
	...
	'revreview-quality' => 'This is the latest [[{{MediaWiki:Makevalidate-page}}|quality]] revision, 
	[{{fullurl:Special:Log|type=review&page={{FULLPAGENAMEE}}}} approved] on <i>$2</i>. The [{{fullurl:{{FULLPAGENAMEE}}|stable=0}} draft] 
	can be [{{fullurl:{{FULLPAGENAMEE}}|action=edit}} modified]; [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} $3 {{plural:$3|change|changes}}] 
	{{plural:$3|awaits|await}} review.',
	'revreview-static' => 'This is a [[{{MediaWiki:Makevalidate-page}}|reviewed]] revision of \'\'\'[[:$3|$3]]\'\'\', 
	[{{fullurl:Special:Log/review|page=$1}} approved] on <i>$2</i>.',
	'revreview-toggle' => '(+/-)',
	'revreview-note' => '[[User:$1]] made the following notes [[{{MediaWiki:Makevalidate-page}}|reviewing]] this revision:',
	...
	'review-logpagetext'   => 'This is a log of changes to revisions\' [[{{MediaWiki:Makevalidate-page}}|approval]] status
	for content pages.',
	...
	'stable-logpagetext' => 'This is a log of changes to the [[{{MediaWiki:Makevalidate-page}}|stable version]] 
    ...
    'revreview-visibility'  => 'This page has a [[{{MediaWiki:Makevalidate-page}}|stable version]], which can be
