...
$messages = array(
	...
	'revreview-noflagged'       => 'I a pas de version revisada d\'aquesta pagina, sa qualitat es incèrtana.',
	...
	'revreview-quick-basic'     => '\'\'\'Vista\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} veire revision correnta]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|modificacion|modificacions}}])',
	'revreview-quick-quality'   => '\'\'\'Qualitat\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} veire version correnta]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|cambiament|cambiaments}}])',
	...
	'review-logpagetext'        => 'Es un jornal de las modificacions per l\'aprobacion de las revisions.',
	...
	'stable-logpagetext'        => 'Es lo jornal de las modificacions per las versions establas de las paginas.',
	...
	'revreview-visibility'      => 'Aquesta pagina conten una version establa, que pòt èsser [{{fullurl:Special:Stabilization|page={{FULLPAGENAMEE}}}} configurada].',
