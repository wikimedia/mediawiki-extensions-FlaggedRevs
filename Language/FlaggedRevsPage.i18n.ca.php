...
$messages = array(
	...
	'revreview-noflagged'       => 'No hi ha versions revisades d\'aquesta pàgina i, per tant, pot \'\'\'no\'\'\' haver estat [[{{MediaWiki:Makevalidate-page}}|comprovada]] la seva qualitat.',
	...
	'revreview-quick-basic'     => '\'\'\'[[{{MediaWiki:Makevalidate-page}}|Revisada]]\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} vegeu la versió actual]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|canvi|canvis}}])',
	'revreview-quick-quality'   => '\'\'\'[[{{MediaWiki:Makevalidate-page}}|Qualitat]]\'\'\'. [[{{fullurl:{{FULLPAGENAMEE}}|stable=0}} vegeu la versió actual]] ($2 [{{fullurl:{{FULLPAGENAMEE}}|oldid=$1&diff=cur&editreview=1}} {{plural:$2|canvi|canvis}}])',
