...
رجاء راجع جميع التغييرات الظاهرة أدناه من أجل أن تظهر تعديلاتك في النسخة المستقرة.',
	...
	'revreview-reject-summary-cur' => 'رفض {{PLURAL:$1||التغيير النصي الأخير|التغييران النصيان الأخيران|ال$1 تغييرات نصية الأخيرة|ال$1 تغييرا نصيا أخيرا|ال$1 تغيير نصي أخير}} (ل$2) واستعدت المراجعة $3 ل$4',
