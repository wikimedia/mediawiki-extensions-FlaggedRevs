...
رجاء راجع جميع التغييرات الظاهرة أدناه من أجل أن تظهر تعديلاتك في النسخة المستقرة.',
	...
	'revreview-reject-summary-cur' => 'رفض {{PLURAL:$1||التغيير النصي الأخير|التغييران النصيان الأخيران|ال‍$1 تغييرات نصية الأخيرة|ال‍$1 تغييرا نصيا أخيرا|ال‍$1 تغيير نصي أخير}} (ل‍$2) واستعادة المراجعة $3 ل‍$4',
	...
	'revreview-reject-summary-cur-short' => 'رفض {{PLURAL:$1||التغيير النصي الأخير|التغييران النصيان الأخيران|ال‍$1 تغييرات نصية الأخيرة|ال‍$1 تغييرا نصيا أخيرا|ال‍$1 تغيير نصي أخير}} واستعادة المراجعة $2 ل‍$3',
...
ראו את [[Special:Unreviewedpages|רשימת הדפים שלא נסקרו]].',
	...
	'revreview-sadv-reviewing-c' => 'לתשומת לבך: נא $1 את עצמך למשתמשים אחרים בתור סוקר השינויים האלה.',
...
Див. також [[Special:Unreviewedpages|список неперевірених сторінок]].',
	...
	'revreview-adv-reviewing-p' => "'''Примітка: Оголошено, що ви почали перевірку цієї сторінки $1 о $2.'''",
